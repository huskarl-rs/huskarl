...
- **Errors** — every operation returns the one concrete [`Error`](https://docs.rs/huskarl-core/latest/huskarl_core/error/struct.Error.html)/[`ErrorKind`](https://docs.rs/huskarl-core/latest/huskarl_core/error/enum.ErrorKind.html),
